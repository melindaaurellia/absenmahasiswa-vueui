...
<div class="card shadow mt-3">
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" id="inputAddress" placeholder="Masukkan matakuliah"
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" id="inputAddress" placeholder="Masukkan Keterangan"
